...
A note before we start making little functions: Please try to do this on your own. Solutions will be provided in the session script! This handout then will be paired with the class script, which will serve as the exercise solution set. It just doesn't exist yet as of this writing :-)
